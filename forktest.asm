...
forktest(void)
{
  ...
  5c:	fa5ff0ef          	jal	0 <print>
    exit(1);
  60:	4505                	li	a0,1
  62:	310000ef          	jal	372 <exit>
      exit(0);
  66:	30c000ef          	jal	372 <exit>
  }
  ...
  84:	f7dff0ef          	jal	0 <print>
    exit(1);
  88:	4505                	li	a0,1
  8a:	2e8000ef          	jal	372 <exit>
  for(; n > 0; n--){
  8e:	00905963          	blez	s1,a0 <forktest+0x7a>
    if(wait(0) < 0){
  92:	4501                	li	a0,0
  94:	2e6000ef          	jal	37a <wait>
